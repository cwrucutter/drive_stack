...
X = [x;y];
% Velocity
v_x = 3 * (1 - t).^2 * (P(1,2) - P(1,1)) + 6 * (1 - t) .* t * (P(1,3) - P(1,2)) + 3 * t.^2 * (P(1,4) - P(1,3));
v_y = 3 * (1 - t).^2 * (P(2,2) - P(2,1)) + 6 * (1 - t) .* t * (P(2,3) - P(2,2)) + 3 * t.^2 * (P(2,4) - P(2,3));
V = [v_x;v_y];
% Acceleration
a_x = 6 * (1 - t) * (P(1,3) - 2 * P(1,2) + P(1,1)) + 6 * t * (P(1,4) - 2 * P(1,3) + P(1,2));
a_y = 6 * (1 - t) * (P(2,3) - 2 * P(2,2) + P(2,1)) + 6 * t * (P(2,4) - 2 * P(2,3) + P(2,2));
A = [a_x;a_y];
if transpose
    X = X';
    V = V';
